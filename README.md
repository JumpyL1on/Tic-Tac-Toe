...
| 403 | Игрок не может создать игру, если он уже в игре | ProblemDetails |
...
| 400 | Игры с таким идентификатором не существует | ProblemDetails |
| 401 | Игрок не авторизован в системе | |
| 403 | Игра завершена или не была создана этим игроком | ProblemDetails |
...
| 400 | Игры с таким идентификатором не существует | ProblemDetails |
| 401 | Игрок не авторизован в системе | |
| 403 | Игрок не может присоединиться к игре, в которой уже есть два игрока | ProblemDetails|
...
| Код | Описание | Возвращаемый тип |
|--|--|--|
| 200 | Игрок успешно сделал ход | |
| 400 | Игры с таким идентификатором не существует | ProblemDetails |
| 401 | Игрок не авторизован в системе | |
| 403 | Игрок не может сделать ход, потому что сейчас не его очередь | ProblemDetails|
## Player
