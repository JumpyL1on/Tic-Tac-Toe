...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230315081936_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Entities.Field", b =>
                {
                    b.HasOne("DataAccess.Entities.Game", "Game")
                        .WithOne("Field")
                        .HasForeignKey("DataAccess.Entities.Field", "Id")
            ...
            modelBuilder.Entity("DataAccess.Entities.Game", b =>
                {
                    b.HasOne("DataAccess.Entities.Player", "PlayerA")
                        .WithMany("PlayerAGames")
                        .HasForeignKey("PlayerAId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("DataAccess.Entities.Player", "PlayerB")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("DataAccess.Entities.Player", null)
                        .WithMany()
